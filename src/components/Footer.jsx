...
const Footer = () => {
  return (
    <footer className="body-font bg-gray-900 text-gray-400">
      <div className="mx-auto flex flex-col items-center px-10 py-8 sm:flex-row">
        <Link
          to="/"
        ...
        <p className="mt-4 text-sm text-gray-400 sm:ml-4 sm:mt-0 sm:border-l-2 sm:border-gray-800 sm:py-2 sm:pl-4">
          © 2022 Just for practice —
          <a href="https://github.com/tkoleo84119" className="ml-1 text-gray-500" target="_blank">
            @Kerwin
          </a>
        </p>
        <span className="mt-4 inline-flex justify-center sm:ml-auto sm:mt-0 sm:justify-start">
          <a href="https://www.linkedin.com/in/kerwinhou/" className="text-gray-400">
            <svg
              fill="currentColor"
              strokeLinecap="round"
              strokeLinejoin="round"
          ...
          <a href="https://www.linkedin.com/in/kerwinhou/" className="ml-3 text-gray-400">
            <svg
              fill="currentColor"
              strokeLinecap="round"
              strokeLinejoin="round"
